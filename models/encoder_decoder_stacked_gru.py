...
def define_nmt(hidden_size,embedding_dim,source_lang_timesteps,source_lang_vocab_size,target_lang_timesteps,target_lang_vocab_size,dropout):
    ...
    decoder_gru1=GRU(hidden_size,return_sequences=True,return_state=True,name='decoder_gru1')
    decoder_out1,decoder_state1=decoder_gru1(decoder_embedded,initial_state=encoder_state1)
    decoder_gru2=GRU(hidden_size,return_sequences=True,return_state=True,name='decoder_gru2')
    ...
    decoder_pred=dense_time(decoder_out2)
    ...
    inf_decoder_state1 = Input(shape=(hidden_size,))
    inf_decoder_state2 = Input(shape=(hidden_size,))
...
def translate(sentence,encoder_model,decoder_model,source_tokenizer,target_tokenizer,src_vsize,tgt_vsize,source_timesteps,target_timesteps):
    ...
    while continuePrediction:
        decoder_pred,decoder_state1,decoder_state2=decoder_model.predict([target_preproc_text,enc_last_state1,enc_last_state2])
